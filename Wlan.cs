  ...
  public static class Wlan
  {
    ...
    public struct WlanAvailableNetwork
    {
      ...
      public Wlan.Dot11PhyType[] Dot11PhyTypes
      {
        get
        {
          Wlan.Dot11PhyType[] destinationArray = new Wlan.Dot11PhyType[ this.numberOfPhyTypes];
    ...
    public struct WlanRateSet
    {
      ...
      public ushort[] Rates
      {
        get
        {
          ushort[] destinationArray = new ushort[ (this.rateSetLength / 2U)];
