...
// Type: AloSpeedportKeyGen.WlanClient
  ...
  public class WlanClient : IDisposable
  {
    ...
    public WlanClient.WlanInterface[] Interfaces
    {
      get
      {
        ...
        try
        {
          ...
          WlanClient.WlanInterface[] interfaces = new WlanClient.WlanInterface[ structure1.numberOfItems];
    ...
    public class WlanInterface
    {
        ...
        IntPtr availNetListPtr)
      {
        ...
        Wlan.WlanAvailableNetwork[] availableNetworkArray = new Wlan.WlanAvailableNetwork[ structure.numberOfItems];
      ...
      public Wlan.WlanProfileInfo[] GetProfiles()
      {
        ...
        try
        {
          ...
          Wlan.WlanProfileInfo[] profiles = new Wlan.WlanProfileInfo[ structure1.numberOfItems];
